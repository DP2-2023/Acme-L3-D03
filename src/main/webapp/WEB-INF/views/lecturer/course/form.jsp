...
<acme:form>
	<jstl:choose>	 
		<jstl:when test="${acme:anyOf(_command, 'show|create|update|delete')}">
			...
			<jstl:choose>	 
				<jstl:when test="${acme:anyOf(_command, 'show|update|delete') && isPublished == false}">
					<acme:submit code="lecturer.lecture.form.button.update" action="/lecturer/course/update"/>
					<acme:submit code="lecturer.lecture.form.button.delete" action="/lecturer/course/delete"/>
					<acme:button code="lecturer.lecture.form.button.add-lecture" action="/lecturer/course/add-lecture?id=${id}"/>
					<acme:button code="lecturer.lecture.form.button.remove-lecture" action="/lecturer/course/remove-lecture?id=${id}"/>
				</jstl:when>
				<jstl:when test="${acme:anyOf(_command, 'show|update|delete')}">
					<acme:button code="lecturer.lecture.form.button.list-lectures" action="/lecturer/lecture/list-mine?masterId=${id}"/>
				</jstl:when>
				<jstl:when test="${_command == 'create'}">
					<acme:submit code="lecturer.lecture.form.button.create" action="/lecturer/course/create"/>
				</jstl:when>
			</jstl:choose>
		</jstl:when>
		...
		<jstl:when test="${acme:anyOf(_command, 'add-lecture|remove-lecture')}">
			...
			<jstl:choose>	 
				<jstl:when test="${_command == 'add-lecture'}">
					<acme:submit code="lecturer.lecture.form.button.add-lecture" action="/lecturer/course/add-lecture"/>
				</jstl:when>
				<jstl:when test="${_command == 'remove-lecture'}">
					<acme:submit code="lecturer.lecture.form.button.remove-lecture" action="/lecturer/course/remove-lecture"/>
				</jstl:when>		
			</jstl:choose>
		</jstl:when>
	</jstl:choose>
